    ...
    with open(filename) as csv_file:
        ...
        for row in csv_reader:
            if line_count == 0:
                ...
                merchants_dict[row[1]]=Merchant(id=row[1],name=row[5],customer_id=row[5], transact_amount=row[5], check_fraud=row[5], age=row[5], gender=row[5], zipcode_ori=row[5], zipcode_dest=row[5], category=row[5])
